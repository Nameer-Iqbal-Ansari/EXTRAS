...
//Date        : Sun Jan 16 07:53:50 2022
//Host        : ip-172-32-20-153.ap-southeast-1.compute.internal running 64-bit CentOS Linux release 7.9.2009 (Core)
//Command     : generate_target cl_design1.bd
//Design      : cl_design1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "cl_design1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cl_design1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "cl_design1.hwdef" *) 
module cl_design1
   (S00_AXI_0_araddr,
    S00_AXI_0_arburst,
    S00_AXI_0_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI_0 ARID" *) input [1:0]S00_AXI_0_arid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI_0 AWID" *) input [1:0]S00_AXI_0_awid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI_0 BID" *) output [1:0]S00_AXI_0_bid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI_0 RID" *) output [1:0]S00_AXI_0_rid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_0 ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXI_0, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN cl_design1_s_axi_aclk_0, DATA_WIDTH 32, FREQ_HZ 10000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S_AXI_0_araddr;
  ...
  (* LOCKED = "TRUE" *) output rsta_busy_0;
  (* LOCKED = "TRUE" *) (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.S_AXI_ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.S_AXI_ACLK_0, ASSOCIATED_BUSIF S00_AXI_0:S_AXI_0, ASSOCIATED_RESET s_axi_aresetn_0, CLK_DOMAIN cl_design1_s_axi_aclk_0, FREQ_HZ 10000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input s_axi_aclk_0;
  ...
  wire [1:0]axi_crossbar_0_M00_AXI_ARID;
  ...
  wire [1:0]axi_crossbar_0_M00_AXI_AWID;
  ...
  wire [1:0]axi_crossbar_0_M00_AXI_BID;
  ...
  wire [1:0]axi_crossbar_0_M00_AXI_RID;
  ...
  wire [1:1]axi_protocol_convert_0_M_AXI_ARREADY;
  ...
  wire [1:1]axi_protocol_convert_0_M_AXI_AWREADY;
  ...
  wire [3:2]axi_protocol_convert_0_M_AXI_BRESP;
  wire [1:1]axi_protocol_convert_0_M_AXI_BVALID;
  wire [127:64]axi_protocol_convert_0_M_AXI_RDATA;
  wire [1:1]axi_protocol_convert_0_M_AXI_RLAST;
  wire axi_protocol_convert_0_M_AXI_RREADY;
  wire [3:2]axi_protocol_convert_0_M_AXI_RRESP;
  wire [1:1]axi_protocol_convert_0_M_AXI_RVALID;
  wire [63:0]axi_protocol_convert_0_M_AXI_WDATA;
  wire axi_protocol_convert_0_M_AXI_WLAST;
  wire [1:1]axi_protocol_convert_0_M_AXI_WREADY;
  ...
  assign S00_AXI_0_1_WDATA = S00_AXI_0_wdata[63:0];
  assign S00_AXI_0_1_WLAST = S00_AXI_0_wlast[0];
  assign S00_AXI_0_1_WSTRB = S00_AXI_0_wstrb[7:0];
  ...
  assign S00_AXI_0_bid[1:0] = S00_AXI_0_1_BID;
  assign S00_AXI_0_bresp[1:0] = S00_AXI_0_1_BRESP;
  assign S00_AXI_0_bvalid[0] = S00_AXI_0_1_BVALID;
  assign S00_AXI_0_rdata[63:0] = S00_AXI_0_1_RDATA;
  assign S00_AXI_0_rid[1:0] = S00_AXI_0_1_RID;
  ...
  cl_design1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  cl_design1_axi_crossbar_0_0 axi_crossbar_0
       (.aclk(s_axi_aclk_0_1),
        ...
        .s_axi_araddr({axi_protocol_convert_0_M_AXI_ARADDR,S00_AXI_0_1_ARADDR}),
        .s_axi_arburst({axi_protocol_convert_0_M_AXI_ARBURST,S00_AXI_0_1_ARBURST}),
        .s_axi_arcache({axi_protocol_convert_0_M_AXI_ARCACHE,S00_AXI_0_1_ARCACHE}),
        .s_axi_arid({1'b0,1'b0,S00_AXI_0_1_ARID}),
        .s_axi_arlen({axi_protocol_convert_0_M_AXI_ARLEN,S00_AXI_0_1_ARLEN}),
        .s_axi_arlock({axi_protocol_convert_0_M_AXI_ARLOCK,S00_AXI_0_1_ARLOCK}),
        .s_axi_arprot({axi_protocol_convert_0_M_AXI_ARPROT,S00_AXI_0_1_ARPROT}),
        .s_axi_arqos({axi_protocol_convert_0_M_AXI_ARQOS,S00_AXI_0_1_ARQOS}),
        .s_axi_arready({axi_protocol_convert_0_M_AXI_ARREADY,S00_AXI_0_1_ARREADY}),
        .s_axi_arsize({axi_protocol_convert_0_M_AXI_ARSIZE,S00_AXI_0_1_ARSIZE}),
        .s_axi_arvalid({axi_protocol_convert_0_M_AXI_ARVALID,S00_AXI_0_1_ARVALID}),
        .s_axi_awaddr({axi_protocol_convert_0_M_AXI_AWADDR,S00_AXI_0_1_AWADDR}),
        .s_axi_awburst({axi_protocol_convert_0_M_AXI_AWBURST,S00_AXI_0_1_AWBURST}),
        .s_axi_awcache({axi_protocol_convert_0_M_AXI_AWCACHE,S00_AXI_0_1_AWCACHE}),
        .s_axi_awid({1'b0,1'b0,S00_AXI_0_1_AWID}),
        .s_axi_awlen({axi_protocol_convert_0_M_AXI_AWLEN,S00_AXI_0_1_AWLEN}),
        .s_axi_awlock({axi_protocol_convert_0_M_AXI_AWLOCK,S00_AXI_0_1_AWLOCK}),
        .s_axi_awprot({axi_protocol_convert_0_M_AXI_AWPROT,S00_AXI_0_1_AWPROT}),
        .s_axi_awqos({axi_protocol_convert_0_M_AXI_AWQOS,S00_AXI_0_1_AWQOS}),
        .s_axi_awready({axi_protocol_convert_0_M_AXI_AWREADY,S00_AXI_0_1_AWREADY}),
        .s_axi_awsize({axi_protocol_convert_0_M_AXI_AWSIZE,S00_AXI_0_1_AWSIZE}),
        .s_axi_awvalid({axi_protocol_convert_0_M_AXI_AWVALID,S00_AXI_0_1_AWVALID}),
        .s_axi_bid(S00_AXI_0_1_BID),
        .s_axi_bready({axi_protocol_convert_0_M_AXI_BREADY,S00_AXI_0_1_BREADY}),
        .s_axi_bresp({axi_protocol_convert_0_M_AXI_BRESP,S00_AXI_0_1_BRESP}),
        .s_axi_bvalid({axi_protocol_convert_0_M_AXI_BVALID,S00_AXI_0_1_BVALID}),
        .s_axi_rdata({axi_protocol_convert_0_M_AXI_RDATA,S00_AXI_0_1_RDATA}),
        .s_axi_rid(S00_AXI_0_1_RID),
        .s_axi_rlast({axi_protocol_convert_0_M_AXI_RLAST,S00_AXI_0_1_RLAST}),
        .s_axi_rready({axi_protocol_convert_0_M_AXI_RREADY,S00_AXI_0_1_RREADY}),
        .s_axi_rresp({axi_protocol_convert_0_M_AXI_RRESP,S00_AXI_0_1_RRESP}),
        .s_axi_rvalid({axi_protocol_convert_0_M_AXI_RVALID,S00_AXI_0_1_RVALID}),
        .s_axi_wdata({axi_protocol_convert_0_M_AXI_WDATA,S00_AXI_0_1_WDATA}),
        .s_axi_wlast({axi_protocol_convert_0_M_AXI_WLAST,S00_AXI_0_1_WLAST}),
        .s_axi_wready({axi_protocol_convert_0_M_AXI_WREADY,S00_AXI_0_1_WREADY}),
        .s_axi_wstrb({axi_protocol_convert_0_M_AXI_WSTRB,S00_AXI_0_1_WSTRB}),
        .s_axi_wvalid({axi_protocol_convert_0_M_AXI_WVALID,S00_AXI_0_1_WVALID}));
  cl_design1_axi_dwidth_converter_0_0 axi_dwidth_converter_0
  ...
  cl_design1_axi_protocol_convert_0_0 axi_protocol_convert_0
       (.aclk(s_axi_aclk_0_1),
        .aresetn(s_axi_aresetn_0_1),
        ...
        .s_axi_araddr({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_dwidth_converter_0_M_AXI_ARADDR}),
        ...
        .s_axi_awaddr({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_dwidth_converter_0_M_AXI_AWADDR}),
  ...
  cl_design1_blk_mem_gen_0_0 blk_mem_gen_0
