...
#
# Generated by export_simulation on Fri Jan 14 07:26:59 UTC 2022
#
################################################################################
...
'-reset_run' switch to the './cl_design1.sh' script.

./cl_design1.sh -reset_run
...
./cl_design1.sh -noclean_files

For more information on the script, please type './cl_design1.sh -help'.
